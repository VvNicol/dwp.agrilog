...
<body>
    <nav class="navbar">
        ...
        <div class="buttons-container">
            ...
            <a href="<%=request.getContextPath()%>/inicio/iniciarSesion.jsp" class="btn btn-transparent btnNav">Iniciar Sesión</a>
            <a href="<%=request.getContextPath()%>/inicio/registrarse.jsp" class="btn btn-transparent btnNav">Registrarse</a>
        </div>
    </nav>
            ...
            <div class="col-12 col-md-10 d-flex align-items-center justify-content-center p-5">
                <div class="col-lg-8 col-md-10 col-12 p-4 formulario bg-light rounded shadow-lg">
                    ...
                    <div class="mt-3 text-center enlaces">
                        <a href="<%=request.getContextPath()%>/inicio/recuperarContrasenia.jsp" class="text-decoration-none d-block mb-2">¿Olvidaste tu contraseña?</a>
                        <a href="<%=request.getContextPath()%>/inicio/registrarse.jsp" class="text-decoration-none">¿No tienes cuenta? Regístrate</a>
                    </div>
                </div>
            </div>
        </div>
